...
df= pd.read_csv('dataset/all_athlete_games.csv')
region_df= pd.read_csv('dataset/all_regions.csv')

df= preprocessor.preprocess(df,region_df)

st.sidebar.title("Olympics Data Dive")
st.sidebar.image('https://www.pngall.com/wp-content/uploads/2017/05/Olympic-Rings-Free-Download-PNG.png')
...
if user_menu == 'Overall Analysis':
    ...
    sports = df['Sport'].unique().shape[0] -15
    ...
    nations_over_time = helper.nation_over_time(df,'Region')
    ...
    athletes_over_time = helper.athlete_over_time(df, 'Name')
